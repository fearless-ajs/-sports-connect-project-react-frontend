...
import './create-player-account.styles.css'
...
import {registerPlayerStart} from "../../../redux/player/player.actions";
...
const CreatePlayerAccountComponent = ({ isLoading, registerPlayerStart }) => {
    ...
    const handleSubmit = event => {
        ...
        registerPlayerStart({ favoriteWingNo, dateOfBirth, nationality, city, state, height, club, phone, linkedInPageLink })
    };
    ...
    return (
        <div className="profile">
            <div className="playerReg">
                <Container>
                    <h2>Create your profile as Player</h2>
                    <Row>
                        <Col md={5}>
                            <Form
                                noValidate
...
const mapDispatchToProps = dispatch => ({
    registerPlayerStart: userCredentials => dispatch(registerPlayerStart(userCredentials))
});

const mapStateToProps = createStructuredSelector({
    isLoading: state => selectCurrentPlayerLoadingStatus(state)
});
export default connect(mapStateToProps, mapDispatchToProps)(CreatePlayerAccountComponent);