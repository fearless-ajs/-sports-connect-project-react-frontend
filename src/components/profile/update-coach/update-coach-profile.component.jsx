...
import UpdatePlayerPrimaryProfileFormComponent from "./update-coach-primary-profile-form.component";
import UpdateCoachPrimaryProfileFormComponent from "./update-coach-primary-profile-form.component";

const UpdateCoachProfileComponent = ({ isPrimaryProfileUpdating, isRegProfileLoading }) => {
            ...
            <div className="signup">
                <Container fluid>
                    ...
                    African Sports and it's Stars to the limelight.
                        ...
                        <Col>
                            {
                                (primaryProfileForm)? <UpdateCoachPrimaryProfileFormComponent /> : null
                            }
                            {
...
export default connect(mapStateToProps)(UpdateCoachProfileComponent);
